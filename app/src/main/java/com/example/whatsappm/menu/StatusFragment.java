...
import com.example.whatsappm.databinding.FragmentStatusBinding;
import com.example.whatsappm.view.activities.status.DisplayStatusActivity;
    ...
    private void getProfile()
    {
        ...
        firestore.collection("Users").document(firebaseUser.getUid()).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                Glide.with(getContext()).load(imageProfile).into(binding.imgProfile);
            }
